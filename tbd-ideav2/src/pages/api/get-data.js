...
function createData( dustbin_lat, dusbin_lng ,area ,last_collected,dustbin_fullness ){
    const promise = databases.createDocument(
        '644d06dd4576ea7fbaad',
        '644d0abfd58662934852',
        ID.unique(),
        {
            'dustbin-lat': dustbin_lat,
...
export default function handler(req, res) {
    if (req.method === 'GET') {
        ...
        const { dustbin_lat, dusbin_lng ,area ,last_collected,dustbin_fullness } = req.body;
        createData(dustbin_lat, dusbin_lng, area, last_collected, dustbin_fullness );
    }
}